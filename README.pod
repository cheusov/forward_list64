...
So, on Linuxes and macOS I'd recommend use the following open source
...
forward_list64 build system is mk-configure (https://github.com/cheusov/mk-configure).
...
forward_list.cc and forward_list64.cc -- tools that may be used for benchmarking
